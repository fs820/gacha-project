...
async function createConstantCheckboxes(characters) {
    ...
    label5.appendChild(new Text("星5"));
...
async function changeBanner() {
    ...
    const banner_select = container?.querySelector(`[name='banner_select']`);
    if (!banner_select) {
...
async function updateChangeBanner() {
    ...
    const banner_select = container_gachaBanner?.querySelector("[name='banner_select']");
    if (!banner_select) {
